...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iueiwt8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iueiwt8.containers.anotherwebservice.com/
...
```
git clone git@github.com:alphauser93/container-iueiwt8.git
cd container-iueiwt8
```
...
```
docker attach container-iueiwt8
```
